...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss = torch.nn.functional.binary_cross_entropy_with_logits(logits_real, true_labels, reduction='mean') + \
           torch.nn.functional.binary_cross_entropy_with_logits(logits_fake, fake_labels, reduction='mean')
    ##############################################################################
    #                              END OF YOUR CODE                              #
    ##############################################################################
    return loss
